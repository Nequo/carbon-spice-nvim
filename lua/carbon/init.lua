...
hl(0, "Title", {fg = c.blue, bg = c.none})
hl(0, "Debug", {fg = c.base13, bg = c.none})
hl(0, "Macro", {fg = c.teal, bg = c.none})
...
hl(0, "DiagnosticInfo", {fg = c.yellow, bg = c.none})
...
-- Syntax
hl(0, "Boolean", {fg = c.pink, bg = c.none})
...
hl(0, "Decorator", {fg = c.teal, bg = c.none})
hl(0, "Define", {fg = c.blue, bg = c.none})
hl(0, "Delimeter", {fg = c.base04, bg = c.none})
hl(0, "Exception", {fg = c.red, bg = c.none})
hl(0, "Function", {fg = c.orange, bg = c.none})
hl(0, "Identifier", {fg = c.base04, bg = c.none})
hl(0, "Include", {fg = c.blue, bg = c.none})
hl(0, "Keyword", {fg = c.blue, bg = c.none})
hl(0, "Label", {fg = c.blue, bg = c.none})
hl(0, "Number", {fg = c.pink, bg = c.none})
hl(0, "Float", {link = "Number"})
hl(0, "Operator", {fg = c.base04, bg = c.none})
hl(0, "PreProc", {fg = c.blue, bg = c.none})
hl(0, "Repeat", {fg = c.blue, bg = c.none})
hl(0, "Special", {fg = c.teal, bg = c.none})
hl(0, "SpecialChar", {fg = c.teal, bg = c.none})
hl(0, "SpecialComment", {fg = c.cyan, bg = c.none})
hl(0, "Statement", {fg = c.blue, bg = c.none})
hl(0, "StorageClass", {fg = c.pink, bg = c.none})
hl(0, "String", {fg = c.green, bg = c.none})
hl(0, "Structure", {fg = c.pink, bg = c.none})
hl(0, "Tag", {fg = c.base04, bg = c.none})
hl(0, "Todo", {fg = c.base00, bg = c.yellow})
hl(0, "Type", {fg = c.pink, bg = c.none})
hl(0, "Typedef", {fg = c.base04, bg = c.none})
hl(0, "markdownBlockquote", {fg = c.base04, bg = c.none})
...
hl(0, "markdownUrl", {fg = c.orange, bg = c.none, underline = true})
...
hl(0, "markdownListMarker", {fg = c.pink, bg = c.none})
hl(0, "markdownOrderedListMarker", {fg = c.pink, bg = c.none})

-- Treesitter
-- hl(0, "@comment", {link = "Comment"})
-- hl(0, "@error", {fg = c.base04, bg = c.none})
-- hl(0, "@operator", {link = "Operator"})
-- hl(0, "@puncuation.delimiter", {fg = c.base04, bg = c.none})
-- hl(0, "@punctuation.bracket", {fg = c.base04, bg = c.none})
-- hl(0, "@punctuation.special", {fg = c.base04, bg = c.none})
...
-- hl(0, "@function", {fg = c.base04, bg = c.none, bold = true})
...
hl(0, "TelescopePromptPrefix", {fg = c.orange, bg = c.base02})
